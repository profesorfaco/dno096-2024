...
Alternativas tales como [p5.js](https://p5js.org/es/), una biblioteca (*library*) de JavaScript mantenida por una comunidad que busca ofrecer *una herramienta amigable para aprender a programar y hacer arte*.
